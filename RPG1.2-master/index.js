...
async function starts() {
	...
	client.on('group-participants-update', async (anu) => {
		...
		try {
			...
			if (anu.action == 'add') {
				...
				teks = `Oiin @${num.split('@')[0]}\nBem vindo ao grupo *${mdata.subject}* Mande *menu pra saber de coisas como a ficha,nerfs,historias e sistemas e mais opcoes`
	...
	client.on('chat-update', async (mek) => {
		try {
			...
			mess = {
				wait: '⌛ Espera um pouco estou fazendo... caso nao apareca nada no intervalo de 1min mande o comando de novo ⌛',
				success: '✔️ Sucesso ✔️',
